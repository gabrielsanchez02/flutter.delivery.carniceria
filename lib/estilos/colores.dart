...
const Color secondaryColor = Color(0xFF65112E);
const Color primaryColor = Color(0xFF0B108C);
const Color primaryColorOpacity = Color(0xFA001620);
const Color hintTextColor = Color(0xFFE4E0E8);
const Color primaryTextColor = Color(0xFFbd022e);
